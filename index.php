...
<header>
  ...
  <div class="header-area header-area2">
    ...
    <div class="container">
      <div id="logo-sticky" class="text-center"><a href="index.html"><img src="images/logo.png" alt="logo"></a> </div>
...
<div class="slider-main">
  <div id="main-slider" class="owl-carousel">
    <div class="item"> <img src="images/slider/1.jpg" alt="slider image">
      <div class="dsc">
        ...
        <div class="row">
          <div class="col-sm-12">
                  ...
                  <div id="filters" class="button-group">
                      ...
                      <button class="btn btn-primary active1" data-filter=".dinner"><i class="flaticon-food-1"></i>Dinner</button>
                      <button class="btn btn-primary active1" data-filter=".dessert"><i class="flaticon-food-2"></i>Dessert</button>
                  </div>          
                  <div class="menu-page">
                              ...
                              <div class="item-wrap">
                                  ...
                                  <div class="col-md-3 col-sm-3 col-xs-3">                                    
                                      <div class="inner">
                                          ...
                                          <span class="order"><a href="#">Order Now <i class="fa fa-angle-right" aria-hidden="true"></i></a></span>
                                      </div>
                                  </div>
                              </div>
                          </div>
        ...
        <fieldset>
          <div class="row">
            <div class="col-sm-12">
              ...
              <div class="form-group">
                <input type="number" id="people_no" name="people_no" class="form-control" required placeholder="How Many People">
              </div>
              <div class="form-group">
                <input type="email" id="email_add" name="email_add" class="form-control" required placeholder="Email">
              </div>
              <div class="form-group">
                <input type="text" id="phone_no" name="phone_no" class="form-control" required placeholder="Phone Number">
              </div>
        ...
        <div class="inner">
          ...
          <div class="slider testimonials">
            <div>
              ...
              <p>Pellentesque habitant morbi tristique senectus et fames ac turpis egestas. Vivamus at nisl eget ipsum vel congue lacus</p>
              <h4>Nidhi Sharma</h4>
            </div>
            <div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="contact-area">
                                <div id="form-messages"></div>
                                <form id="contact-form" method="post" action="http://rstheme.com/products/html/khadok/khadok-demo/mailer.php">
                                    <fieldset>
                                        <div class="row">                                      
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="form-group">
...
<!-- Mirrored from rstheme.com/products/html/khadok/khadok-demo/index-onepage.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Sep 2018 11:42:28 GMT -->
</html>
